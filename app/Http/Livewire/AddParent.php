...
class AddParent extends Component
{
    ...
    // دالة تحدد كيف يتم عرض البيانات في الواجهة
    ...
    public function firstStepSubmit()
    {
       $this->validate([
            ...
            'Phone_Father' => 'required|regex:/^([0-9\s\-\+\(\)]*)$/|min:9',
    ...
    public function submitForm(){
        ...
        try {
            ...
            // عند رفع مرفقات ولي الأمر، يتم حفظ الملفات داخل مجلد يحمل رقمه الوطني، ويتم تسجيل اسم الملف في قاعدة البيانات وربطه بولي الأمر المناسب.
            if (!empty($this->photos)){
                foreach ($this->photos as $photo) {
                    $photo->storeAs($this->National_ID_Father, $photo->getClientOriginalName(), $disk = 'parent_attachments'); // disk refar to config/filesystem 
            ...
            $this->successMessage = trans('messages.success'); // Save success massage
            $this->clearForm();
            $this->currentStep = 1;         // To Return Back To Page num 1
        }
