...
class OtherController extends Controller
{
    ...
    {
        $grades = Other::all();  // هذا هو المتغير الذي سيتم تمريره إلى الـ View
        return view('pages.other.create', compact('grades'));
    }

    public function create()
    {
        $grades = Grade::all();  // استرجاع البيانات من جدول grades
        return view('pages.other.create', compact('grades'));  // تمرير المتغير grades إلى الـ View
    }
    ...
    public function destroy($id)
    {
      ...
      // Add this method to get classrooms based on grade ID
    public function getClasses($gradeId)
    {
        // Fetch the classrooms based on the selected grade
        $classrooms = Classroom::where('Grade_id', $gradeId)->pluck('Name_Class', 'id');
