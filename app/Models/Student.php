...
class Student extends Authenticatable
{
    ...
    public function gender()    // gender() اسم العلاقه
    {                           // Gender اسم المودل مع الامتداد
                                // gender_id هذا المفتاح الاجنبي الموجود في جدول الطالب لجلب البيبانات
    ...
    {
        return $this->morphMany('App\Models\Image', 'imageable'); // imageable يعتبر مفتاح تجنبي من الصور
    }
