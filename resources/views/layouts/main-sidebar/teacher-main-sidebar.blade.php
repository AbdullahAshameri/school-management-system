<div class="scrollbar side-menu-bg" style="overflow: scroll">
    <ul class="nav navbar-nav side-menu" id="sidebarnav">
        ...
        <!-- الاقسام-->
        <li>
            <a href="{{route('sections')}}"><i class="nav-icon fas fa-table"></i><span
                    class="right-nav-text">الاقسام</span></a>
        </li>

        <!-- الطلاب-->
        <li>
            <a href="{{route('student.index')}}"><i class="nav-icon far fa-user"></i><span
        ...
        <li>
            <a href="javascript:void(0);" data-toggle="collapse" data-target="#sections-menu1">
                <div class="pull-left"><i class="nav-icon fas fa-table"></i><span
