                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <div class="table-responsive mt-15">
                                                            <table class="table center-aligned-table mb-0">
                                                                ...
                                                                <tr class="text-dark">
                                                                    <th>#</th>
                                                                    <th>{{ trans('Sections_trans.Name_Section_') }}
                                                                    </th>
                                                                                                ...
                                                                                                <label
                                                                                                    ...
                                                                                                    <div class="col">
                                                                                                        ...
                                                                                                        <select multiple name="teacher_id[]" class="form-control" id="exampleFormControlSelect2">
                                                                                                            @foreach($list_Sections->teachers as $teacher) {{-- يرجع بقائمة اساتذة القسم الواحد --}}
                                                                                                                <option selected value="{{$teacher['id']}}">{{$teacher['Name']}}</option>
                                                                                                            @endforeach

                                                                                                            @foreach($teachers as $teacher) {{--  اضافة وتعديل وحذف استاذ  --}}
